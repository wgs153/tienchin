...
//                            .enableSwagger() // 开启 swagger 模式
                            .outputDir("D:/project/tienchin/tienchin-clue/src/main/java"); // 指定输出目录
                })
                ...
                .packageConfig(builder ->
                        builder.parent("org.javaboy.tienchin") // 设置父包名
                                ...
                                .pathInfo(Collections.singletonMap(OutputFile.xml, "D:/project/tienchin/tienchin-clue/src/main/resources/mapper")) // 设置mapperXml生成路径
                )
